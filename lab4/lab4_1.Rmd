...
```{r}
select(fish, matches("a.+er")) #handy bit of code for the project especially
```
...
```{r}
mammals_new <- rename(mammals, afr="AFR", genus="Genus", wean_mass="wean mass", max_life="max. life", litter_size="litter size", litters_per_year="litters/year")
```
