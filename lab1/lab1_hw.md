...
R is the programming language that we are learning how to use in this class. It is difficult to interact with on its own, which is why we use RStudio. RStudio is a GUI that allows programming in a more user-friendly format. GitHub is an internet forum that allows people to share their code with one another, which is very useful for things like jobs and college courses such as BIS 15L.
