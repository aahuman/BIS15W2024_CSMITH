...
homerange %>% 
  ggplot(aes(x = log10.mass)) +
  geom_histogram(color = "black", fill = "deepskyblue3", bins=10)+
  labs(title = "Distribution of Body Mass")
```
...
homerange %>% 
  ...
  geom_histogram( fill = "violetred4", alpha = 0.4, color = "black")+
...
homerange %>% 
  ggplot(aes(x=log10.hra))+
  geom_histogram(aes(y = after_stat(density)), fill = "violetred4", 
